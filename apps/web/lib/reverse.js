...
export const reverseTheme = {
  ...
  tokens: {
    ...
    "--color-text-secondary": "light-dark(#3B494A, #9EAEB0)",
    "--color-text-disabled": "light-dark(#849495, #526162)",
    ...
    "--color-icon-secondary": "light-dark(#3B494A, #9EAEB0)",
    "--color-icon-disabled": "light-dark(#849495, #526162)",
    ...
    "--color-border-emphasized": "light-dark(#869698, #5C6B6C)",
    "--color-skeleton": "light-dark(#9EAEB0, #3B494A)",
    ...
    "--color-track": "light-dark(#9EAEB0, #3B494A)",
    "--radius-chat": "28px",
