...
/**
 * reverse theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { reverseTheme } from './reverse';
 *   import './reverse.css';
 */
export const reverseTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "\"Noto Sans KR Variable\", Noto Sans KR, Apple SD Gothic Neo, Malgun Gothic, system-ui, sans-serif",
    "--font-family-heading": "\"Noto Sans KR Variable\", Noto Sans KR, Apple SD Gothic Neo, Malgun Gothic, system-ui, sans-serif",
    ...
    "--color-background-surface": "light-dark(#FFFCF6, #122021)",
    "--color-background-body": "light-dark(#F4EFE5, #091314)",
    "--color-background-card": "light-dark(#FFFCF6, #122021)",
    "--color-background-popover": "light-dark(#FFFCF6, #1B2A2B)",
    "--color-background-muted": "light-dark(#EAE2D5, #243334)",
    "--color-accent": "light-dark(#006B73, #00DCE9)",
    ...
    "--color-neutral": "light-dark(#0E1E1F1A, #D2E6E833)",
    "--color-overlay": "light-dark(#0E1E1F66, #0E1E1F99)",
    "--color-overlay-hover": "light-dark(#0E1E1F0D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#0E1E1F1A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#142E32, #E6F0EF)",
    "--color-text-secondary": "light-dark(#536568, #A8BAB9)",
    "--color-text-disabled": "light-dark(#7A9698, #496365)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #003A42)",
    ...
    "--color-icon-primary": "light-dark(#0E1E1F, #D2E6E8)",
    "--color-icon-secondary": "light-dark(#324B4D, #94B0B3)",
    "--color-icon-disabled": "light-dark(#7A9698, #496365)",
    ...
    "--color-border": "light-dark(#D9D0C3, #334546)",
    "--color-border-emphasized": "light-dark(#A89D8E, #5F7374)",
    "--color-skeleton": "light-dark(#94B0B3, #324B4D)",
    ...
    "--color-background-inverted": "light-dark(#0E1E1F, #EDFFFF)",
    "--color-track": "light-dark(#94B0B3, #324B4D)",
    "--radius-chat": "28px",
